...
fn test_c_sharp_followed_by_c_natural() {
    ...
    // C#4 (MIDI 61)
    let xml1 = emitter.generate_note_xml(61, 4, false, false, "1");
    assert!(xml1.contains("<accidental>sharp</accidental>"));
    
    // C4 (MIDI 60)
    let xml2 = emitter.generate_note_xml(60, 4, false, false, "1");
...
fn test_c_sharp_octave_isolation() {
    ...
    // C#5 (MIDI 73)
    let xml2 = emitter.generate_note_xml(73, 4, false, false, "1");
