...
**🍎 macOS**
```bash
# 1. Install Node.js (if not installed, using Homebrew is recommended)
brew install node
...
# 2. Install Rust & C++ Build Tools
# Download and run rustup-init.exe from https://rustup.rs/
# Note: You MUST install the "Desktop development with C++" workload via the Visual Studio Installer if prompted.

# 3. Install wasm-pack (Run in PowerShell or Command Prompt)
cargo install wasm-pack
...
**🐧 Linux (Ubuntu/Debian)**
```bash
# 1. Install Node.js and essential build tools
